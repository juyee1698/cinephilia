...
function createAdmin($request_values){
	global $conn, $errors, $role, $username, $email,$country;
	...
	if (empty($country)) { array_push($errors, "Oops.. Country is missing"); }
	if (empty($age)) { array_push($errors, "Oops.. Age is missing"); }
	...
	if (count($errors) == 0) {
		$query = "INSERT INTO users (username, email, country, age, role, password, created_at, updated_at) 
				  VALUES('$username', '$email','$country', '$age', '$role', '$password', now(), now())";
...
{
	global $conn, $username, $role, $isEditingUser, $admin_id, $email, $country, $age;
...
function updateAdmin($request_values){
	global $conn, $errors, $role, $username, $isEditingUser, $admin_id, $email, $country, $age;
