...
<body style="background-color: #DEE6E2;">
	<?php if (isset($_SESSION['user']['username'])) { ?> 
	   ...
	   <br><br>
	   <h1 style="margin-left:70px;">Star Wars Fandom</h1>
	   <br>
...
<?php 
$result = mysqli_query($conn,"SELECT * from community where did=4");
?>
...
while($rows = mysqli_fetch_assoc($result))
			 ...
			 <div class="row">
              <img src="./static/images/user1.png" width=6% height=6%>&nbsp;&nbsp;
