...
<div class="row" id="movie" style="background-color:#DEE6E2 ";>
   ...
   <br>
     ...
     <img src="./static/images/memento.jpg" class="img-responsive" alt="memento" width="600" height="400">
	   <br>
	    <center><p style="font-family:Serif;font-size:32px;">Memento</p></center>
	    <p style="font-family:Serif;font-size:25px;align-text:center">Director: Christopher Nolan<br>
	    Initial release: 5 November 2000 (Venice)<br>
   ...
   <br>
     <div class="container-fluid">
     <center><img src="./static/images/memento.jpg" class="img-responsive" alt="memento" width="300" height="200"></center>
	 <br>
	    <center><p style="font-family:Serif;font-size:38px;">Memento</p></center><br>
	    <center><p style="font-family:Serif;font-size:28px;">Director: Christopher Nolan<br>
	    Initial release: 5 November 2000 (Venice)<br>
	    Genre: Drama/Crime<br></p>
	    <h3>Our Ratings</h3>
		<span class="fa fa-star checked" style="margin-left:20px"></span>
   ...
   <br>
     <div class="container-fluid">
     <center><img src="./static/images/memento.jpg" class="img-responsive" alt="memento" width="200" height="100"></center>
	 <br>
	    <center><p style="font-family:Serif;font-size:30px;">Memento</p></center><br>
	    <center><p style="font-family:Serif;font-size:24px;">Director: Christopher Nolan<br>
	    Initial release: 5 November 2000 (Venice)<br>
	    Genre: Drama/Crime<br></p>
	    <h3>Our Ratings</h3>
		<span class="fa fa-star checked" style="margin-left:20px"></span>
...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
	<br><br>
	  ...
	  <iframe  width="800" height="400" align="center" src="https://www.youtube.com/embed/UFuFFdK7i44">
      </iframe>
	  
	  </div>
      <div class="hidden-lg col-md-8 hidden-sm hidden-xs">
	
	  <iframe  width="600" height="300" align="center" src="https://www.youtube.com/embed/UFuFFdK7i44">
      </iframe>
	  ...
	  <iframe class="resp-iframe" src="https://www.youtube.com/embed/UFuFFdK7i44" gesture="media"  allow="encrypted-media" allowfullscreen>
      </iframe>
	  </div>
	  </div>
	  <!-- 2 -->
	   ...
	   <br>
	    <p style="font-family:Serif;font-size:38px;">Memento</p>
	  </div>
	 </div>
	</div>
...
$result = mysqli_query($conn,"SELECT * from reviews where movie_id=4");
