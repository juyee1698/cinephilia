...
<div class="row" style="background-color:#DEE6E2 ";>
   ...
   <br>
     ...
     <img src="static/images/500.jpeg" class="img-responsive" alt="500 days of summer" width="600" height="400">
	   <br>
	    <center><p style="font-family:Serif;font-size:32px;">500 days of summer</p></center>
	    <p style="font-family:Serif;font-size:25px;align-text:center">Director: Marc Webb<br>
	    Initial release: 17 July 2009 (USA) <br>
	    Genre: Romance<br></p>
	     <h3>Our Ratings</h3>
   ...
   <br>
     <div class="container-fluid">
     <center><img src="static/images/500.jpeg" class="img-responsive" alt="500 days of summer" width="300" height="200"></center>
	 <br>
	    <center><p style="font-family:Serif;font-size:38px;">500 days of summer</p></center><br>
	    <center><p style="font-family:Serif;font-size:28px;">Director: Marc Webb<br>
	    Initial release: 17 July 2009 (USA) <br>
	    Genre: Romance <br></p>
	     <h3>Our Ratings</h3>
		<span class="fa fa-star checked" style="margin-left:20px"></span>
   ...
   <br>
     <div class="container-fluid">
     <center><img src="static/images/500.jpeg" class="img-responsive" alt="500 days of summer" width="200" height="100"></center>
	 <br>
	    <center><p style="font-family:Serif;font-size:30px;">500 days of summer</p></center><br>
	    <center><p style="font-family:Serif;font-size:24px;">Director: Marc Webb<br>
	    Initial release: 17 July 2009 (USA)<br>
	    Genre: Romance<br></p>
	     <h3>Our Ratings</h3>
		<span class="fa fa-star checked" style="margin-left:20px"></span>
...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
	<br><br>
	  ...
	  <iframe  width="800" height="400" align="center" src="https://www.youtube.com/embed/PsD0NpFSADM">
      </iframe>
	  
	  </div>
      <div class="hidden-lg col-md-8 hidden-sm hidden-xs">
	
	  <iframe  width="600" height="300" align="center" src="https://www.youtube.com/embed/PsD0NpFSADM">
      </iframe>
	  ...
	  <iframe class="resp-iframe" src="https://www.youtube.com/embed/PsD0NpFSADM" gesture="media"  allow="encrypted-media" allowfullscreen>
      </iframe>
	  </div>
	  </div>
	  <!-- 2 -->
	   ...
	   <br>
	    <p style="font-family:Serif;font-size:38px;">500 days of summer</p>
	  </div>
	 </div>
	</div>
